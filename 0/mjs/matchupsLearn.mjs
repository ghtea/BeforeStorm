...
const HeroID = objMatchupFriend[Object.keys(objMatchupFriend)[0]]['mainHeroID'];
...
function heroTop({heroId, cMap,focusHero, which}) {
...
var numTryRate = obj[heroId]['TryTate']
...
<${Card} focusHero=${focusHero} fHeroId=${fHeroId}  visibleF=${visibleF} which=${fWhich}/>
